...
import Oil from '../Home screen/Oil'
import Cng from '../Home screen/Cng'
import Charging from '../Home screen/Charging'

const Tab = createMaterialTopTabNavigator()

const Charging1 = ({ navigation }) => {
    return (
        <View style={styles.container1}>
            ...
            <Tab.Navigator screenOptions={{
                ...
                <Tab.Screen name='CHARGING' component={Oil} />
                <Tab.Screen name='PETROL/DIESEL' component={Cng} />
                <Tab.Screen name='CNG' component={Charging} />
            </Tab.Navigator>
        </View>
    )
}

export default Charging1
