...
const Booking3 = ({ navigation }) => {
    return (
        <View style={styles.container}>
            <ScrollView contentContainerStyle={{ height: verticalScale(800) }} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.bookingdetails}>
                    ...
                    <Text style={[styles.text10, { top: moderateScale(3) }]}>Service Name: <Text style={{ fontSize: moderateScale(12), fontWeight: '400', color: '#333333' }}>General Service</Text></Text>
                </View>
            </ScrollView>
        </View>
    )
