                        ...
                        <View style={styles.container6}>
                            ...
                            <View style={styles.container7}>
                                <Pressable style={styles.imgcontainer}>
                                    <Image source={require('../Screens/icon/imges/Imagcontainer1.png')} style={{ width: scale(32), height: scale(32) }} />
                                </Pressable>
                            ...
                            <View style={{ flexDirection: 'row', height: verticalScale(144), width: moderateScale(320) }}>
                                <View style={styles.container9}>
                                    <Pressable style={styles.imgcontainer1}>
                                        <Image source={require('../Screens/icon/emergency-icons/Fender2.png')} style={styles.img2} />
                                    </Pressable>
