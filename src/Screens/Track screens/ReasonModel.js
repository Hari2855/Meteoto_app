        ...
        >
            ...
            <Pressable style={styles.container} onPress={closeModal}>
                ...
                <View style={styles.radiocontainer}>
                    ...
                    <Text style={[styles.text2, { marginLeft: moderateScale(10) }]}>Technical Compatibility Concerns.</Text>
                </View>
                ...
                <View style={styles.radiocontainer}>
                    ...
                    <Text style={[styles.text2, { right: moderateScale(20) }]}>Delivery Location Changed.</Text>
                </View>
                ...
                <View style={styles.radiocontainer}>
                    ...
                    <Text style={[styles.text2, { right: moderateScale(28) }]}>My reason not listed here.</Text>
                </View>
