...
import PicCarModel from './PicCarModel'
import CancelModel2 from './CancelModel2'
        ...
        <View style={styles.container}>
            ...
            <View style={styles.container2}>
                <View style={styles.time}>
                    <Text style={styles.text9}>You can cancel within 02:00 min</Text>
                </View>
                <Pressable style={styles.cancelbutton} onPress={toggleModal1}>
                    <Text style={styles.text10}>Cancel</Text>
                </Pressable>
                <CancelModel2 isVisible={cancelModel}
