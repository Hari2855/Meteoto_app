    ...
    return (
        <View style={styles.container}>
            ...
            {/* <View style={styles.status}>
                <Text style={styles.text1}>Mechanic Found!</Text>
            </View> */}
            {showPopup && (
                <View style={styles.status}>
                    <Text style={styles.text1}>Key Maker Found!</Text>
                </View>
            )}
            {!showPopup && (
                <View style={styles.status}>
                    <Text style={styles.text1}>Expected arrival in <Text style={styles.tex}>10:00</Text> Min</Text>
                </View>
            )}
