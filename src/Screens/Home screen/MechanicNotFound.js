...
const MechanicNotFound = ({navigation}) => {
  return (
    <View style={styles.container}>
          <View style={styles.textContainer}>
              <Text style={styles.text}>MECHANIC 24X7</Text>
          </View>

          <Image source={require('../icon/illustration/Empty1.png')} style={styles.img}/>

          <View style={styles.textContainer1}>
            <Text style={styles.text1}>we couldn't find any mechanic</Text>
            <Text style={[styles.text1, {marginTop: moderateScale(5)}]}>nearby you!</Text>
          </View>

          <View style={styles.buttonContainer}>
            <Text style={styles.text2}>You might look for Towing Service</Text>
            <Pressable style={styles.button}>
                <Text style={styles.text3}>TOW MY CAR</Text>
            </Pressable>
          </View>
...
export default MechanicNotFound
