        ...
        <ScrollView contentContainerStyle={styles.container}>
            ...
            <View style={styles.container3}>
                <Pressable style={styles.imgcontainer}>
                    <Image source={require('../icon/imges/imgcontainer1.png')} style={styles.img1} />
                </Pressable>
            ...
            <View style={styles.container8}>
                ...
                <Text style={[styles.text5, { color: '#c7c7c7' }]}>(0 reviews)</Text>
                <Image source={require('../icon/illustration/reviewillustration.png')} style={styles.img3} />
                <Text style={{ fontSize: moderateScale(16), fontWeight: '500', color: '#bbbbbb', alignSelf: 'center', marginTop: moderateScale(10) }}>Add first Review</Text>
