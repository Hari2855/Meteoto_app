...
const AutoHome = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <ImageBackground source={require('../icon/imges/Rectangle54.png')} style={styles.img}>
            </ImageBackground>

            <Text style={styles.text}>I WANT TO PURCHASE AUTOPART FOR</Text>
            ...
            <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
                <Pressable style={styles.car} onPress={() => { navigation.navigate('Autoparsmenu') }}>
