...
const Newaddress = ({ navigation }) => {
    ...
    const showPopup = () => {
        navigation.navigate('NewUpdatedaddress')
        setPopupVisible(true);
    };

    const showPopup1 = () => {
        navigation.navigate('OneTimeaddress')
        setPopupVisible(true);
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.Text1}>NEW ADDRESS</Text>
            ...
            <View style={styles.buttoncontainer}>
                <Pressable style={styles.button1} onPress={showPopup}>
                    <Text style={{fontSize: moderateScale(12), fontWeight: '500', color: '#33CCCC'}}>SAVE FOR FUTURE</Text>
                </Pressable>
                <Popup isVisible={popupVisible} onClose={closePopup} />
                <Pressable style={[styles.button1, { backgroundColor: '#33CCCC', marginLeft: moderateScale(15) }]} onPress={showPopup1}>
                    <Text style={{ fontSize: moderateScale(12), fontWeight: '500', color: '#ffffff' }}>THIS TIME ONLY</Text>
                </Pressable>
            </View>
        </View>
    )
