...
const OneTimeaddress = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
          ...
          <Text style={styles.Text4}>NEW ADDRESS(ONE TIME ONLY)</Text>
          <Pressable style={[styles.addressContainer,{ borderWidth: color == 2 ? 3 : 0, borderColor: color == 2 ? '#33CCCC' : '#ffffff' }]} onPress={() => setcolor(2)}>
              <Image source={require('../icon/emergency-icons/Bill1.png')} style={styles.img} />
              <Text style={styles.Text3}>Maharana Pratap Nagar...</Text>
              <Pressable style={styles.edit} onPress={() => navigation.navigate('Updateaddress')}>
                  <Image source={require('../icon/emergency-icons/Edit.png')} style={styles.img1} />
              </Pressable>
          </Pressable>
          <Text style={{ fontSize: moderateScale(12), fontWeight: '500', color: '#ffffff', marginLeft: moderateScale(20) }}>Selected</Text>
          <View style={styles.line}></View>
