...
import CancelModel3 from '../Track screens/CancelModel3'


const Autopartstrack = ({ navigation }) => {
    ...
    return (
        <View style={styles.container1}>
            ...
            <View style={styles.container4}>
                <Pressable style={[styles.box1, { backgroundColor: color == 2 ? '#33cccc' : '#333333' }]} onPress={() => setColor(2)}>
                    <Text style={styles.text3}>Car Service</Text>
                </Pressable>
                <Pressable style={[styles.box2, { backgroundColor: color == 0 ? '#33cccc' : '#333333' }]} onPress={() => setColor(0)}>
                    <Text style={styles.text3}>Autoparts</Text>
                </Pressable>
                <Pressable style={[styles.box3, { backgroundColor: color == 1 ? '#33cccc' : '#333333' }]} onPress={() => setColor(1)}>
                    ...
                    {square == 0 ? <View>
                        <View style={[styles.view, { marginTop: moderateScale(20), flexDirection: 'column' }]}>
                            <View style={styles.cancel}>
                                ...
                                <Pressable style={styles.cancelcontainer} onPress={toggleModal}>
