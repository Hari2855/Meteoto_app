...
const Verification  = ({ navigation }) => {
    ...
    return (
        <View style={styles.container1}>
            ...
            {/* <Pressable onPress={() => navigation.navigate('Signup')} style={{ bottom: '35%', marginLeft: moderateScale(20), position: 'relative'}}>
            <Image source={require('../Screens/icon/imges/arrow.png')} style={styles.img}/>
            </Pressable> */}
